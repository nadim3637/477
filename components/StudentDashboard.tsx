  ...
  useEffect(() => {
      const interval = setInterval(async () => {
          ...
          if (accountAgeHours < 24 && dailyStudySeconds >= 3600 && !firstDayBonusClaimed) {
              ...
              storage.setItem('nst_users', JSON.stringify(storedUsers));
              storage.setItem('nst_current_user', JSON.stringify(updatedUser));
          ...
          return (
              <div className="space-y-6 pb-24">
                ...
                <div className="space-y-4 pt-4 border-t border-slate-200">
                    ...
                    {/* AI TOUR (GLOWING) */}
                    <div 
                        onClick={() => onTabChange('AI_CHAT' as any)}
                  ...
                  {/* 🥉 LAYER 3 - POWER USER ZONE (Replaces Old Grid) */}
